...
export default (() => {
  ...
  return [
    [img1, -0.5585486420134362 * scale, -3.9373147490685803, 5, 0, 0.75 * mScale],
    [img2, 1.2658082998471168 * scale, -11.546249109522778, 10, 0.25, 0.725 * mScale],
    [img3, -1.9467783978748945 * scale, -14.812371431221711, 15, 0.25, 0.7 * mScale],
    [img4, 2.99601069694845874 * scale, -4.10862465704651, 20, 0.75, 0.675 * mScale],
    [img5, -1.8993567183341669 * scale, -14.813132752114951, 25, 1, 0.65 * mScale],
    [img6, 1.8375452075389486 * scale, -12.13103791856008, 30, 1, 0.625 * mScale],
    [img7, -1.8776788044001291 * scale, -12.032336156141714, 35, 1.5, 0.6 * mScale],
    [img8, 1.0749348594509635 * scale, -11.031316605440301, 40, 1.75, 0.575 * mScale],
    [img9, -2.4000439407834233 * scale, -13.164578222990698, 45, 2, 0.55 * mScale],
    [img10, -2.7065939344543151 * scale, -8.871286874370471, 40, 1.25, 0.525 * mScale],
    [img11, 0.3849091162266927 * scale, -20.0874592327078005, 30, 1.25, 0.5 * mScale],
    [img12, -2.566920223782157 * scale, -7.577466274058035, 16, 1.75, 0.475 * mScale],
    [img13, 1.472727466653086 * scale, -16.016837845215539, 20, 1.5, 0.45 * mScale],
    [img14, 1.5343322678763767 * scale, -16.235258169213427, 30, 2, 0.425 * mScale],
  ]
})()
